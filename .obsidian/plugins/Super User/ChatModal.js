const { Plugin, Modal, MarkdownRenderer, Notice, App } = require('obsidian');
...
class ChatModal extends Modal {
    ...
    async searchNotes(query, resultsContainer) {
        ...
        this.searchResults = files
            ...
            .slice(0, 5);
        this.displaySearchResults(this.searchResults, container, (file) => `[[${file.basename}]]`);
    }
    ...
    displayMessage(sender, message) {
        ...
        // Pass 'this.plugin' as component context
